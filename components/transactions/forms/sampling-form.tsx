...
export default function SamplingForm({ onSubmit }: { onSubmit: () => void }) {
  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium mb-1">Number of Fish Sampled</label>
          <input
            type="number"
            name="fishSampled"
            placeholder="0"
            value={formData.fishSampled}
            onChange={handleChange}
            className="w-full px-3 py-2 border border-input rounded-lg bg-background"
            required
          />
